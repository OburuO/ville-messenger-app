                        ...
                        >
                            ...
                            {!isAudio(attachment) && (
                                <a 
                                    ...
                                    items-center justify-center text-gray-100 bg-gray-700 rounded absolute right-0 top-0 cursor-pointer
                                    hover:bg-gray-800'
                                >
                            ...
                            {isAudio(attachment) && (
                                <div className='flex justify-center items-center bg-black/60 w-32 h-32'>
