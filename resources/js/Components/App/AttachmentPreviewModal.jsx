                        ...
                        <div className="h-screen w-screen">
                            ...
                            >
                                ...
                                bg-slate-800 text-left align-middle shadow-xl transition-all">
                                    <button
                                        onClick={close}
                                        className="absolute right-3 top-3 w-10 h-10 rounded-full hover:bg-black/10 transition-all flex items-center justify-center text-gray-100 z-40"
                                    >
                                        ...
                                        {attachment && (
                                            <div className="flex items-center justify-center w-full h-full p-3">
                                                ...
                                                {!isPreviewable(attachment) && (
                                                    <div className="p-32 flex flex-col justify-center text-gray-100">
