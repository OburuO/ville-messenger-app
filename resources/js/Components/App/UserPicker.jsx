                ...
                <div className="relative mt-1">
                    ...
                    sm:text-sm">
                        <Combobox.Input
                            ...
                            dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full text-sm"
                    ...
                    <Transition
                        ...
                        afterLeave={() => setQuery('')}
                    >
                        <Combobox.Options className="absolute mt-1 max-h-48 w-full overflow-auto rounded-md bg-gray-900 py-1 text-base shadow-lg ring-1
