...
class MessageObserver
{
    ...
    {
        // Iterate over the message's and delete them from file system
        ...
        // Delete all the attachments related to the message from the database
        $message->attachments()->delete();

        // Update the Group's and Conversation's last messsage if the message is the last message
        if ($message->group_id) {
